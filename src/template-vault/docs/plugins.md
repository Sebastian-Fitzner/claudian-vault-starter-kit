...
The vault works without Obsidian. These plugins are optional if you want to use Obsidian as the UI.
**Claudian** adds an in-vault AI panel; the rest are quality-of-life.
